...
namespace SwedbankPay\Core\Block\Adminhtml\System\Config\Fieldset;
...
class Payment extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    ...
    protected function _getHeaderTitleHtml($element)
    {
        ...
        $html .= '<div class="button-container"><button type="button"' .
            ...
            (empty($groupConfig['swedbank_pay_ec_separate']) ? '' : ' swedbank-pay-ec-separate') .
            $disabledClassString .
            '" id="' .
            $htmlId .
            '-head" onclick="swedbankPayToggleSolution.call(this, \'' .
            $htmlId .
            "', '" .
            $this->getUrl(
                'adminhtml/*/state'
    ...
    protected function _getExtraJs($element)
    {
        $script = "require(['jquery', 'prototype'], function(jQuery){
            window.swedbankPayToggleSolution = function (id, url) {
                var doScroll = false;
